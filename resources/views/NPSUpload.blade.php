...
<head>
    ...
    <title>Upload NPS Excel File</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-6 max-w-7xl w-full">
    <div class="w-full max-w-5xl bg-white shadow-lg rounded-xl p-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Upload NPS Excel File</h2>
        ...
        {{-- Upload Form --}}
        <form id="uploadForm" action="{{ route('nps.upload.process') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <label class="block">
                <span class="text-gray-700">Choose an NPS Excel file</span>
